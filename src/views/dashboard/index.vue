      ...
      <div class="left">
        <div class="panel">
          ...
          <div class="todo-list">
            <div class="todo-item">
              <span>组织总人数</span>
              <!-- count-to组件的三个属性：起始值start-val，终点值end-val，动画时间duration，单位是ms -->
        ...
        <div class="panel">
          ...
          <div class="quick-entry">
            <router-link to="/department" class="entry-item">
            ...
            <router-link to="/employee" class="entry-item">
            ...
            <div class="help-left">
              ...
              <div class="help-list">
                <div class="help-block">
                  <i class="icon-entry" /> 入门指南
                </div>
                <div class="help-block">
                  <i class="icon-help" /> 在线帮助手册
                </div>
                <div class="help-block">
                  <i class="icon-support" /> 联系技术支持
                </div>
                <div class="help-block">
                  <i class="icon-add" /> 添加链接
                </div>
              </div>
            </div>
        ...
        <div class="panel">
          ...
          <div class="information-list">
            <div v-for="(item, index) in list" :key="index" class="information-list-item">
              <img v-if="index==0" src="@/assets/icon1.png" alt="">
              <img v-else-if="index==1" src="@/assets/icon2.png" alt="">
              <img v-else-if="index==2" src="@/assets/icon3.png" alt="">
              <img v-else-if="index==3" src="@/assets/icon4.png" alt="">
              <div>
                <p>{{ item.notice }}</p>
                <p>{{ item.createTime }}</p>
              </div>
...
// 按需引入ECharts图表文件
// 使用文档：https://echarts.apache.org/handbook/zh/basics/import
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        {
          notice: '小黄人永远都是那么可爱',
          createTime: '2023-3-7 12:01:00'
        },
        {
          notice: '北海公园是北京的一个象征，坐落于故宫的主线附近，非常值得一去',
          createTime: '2023-4-7 12:01:00'
        },
        {
          notice: '天坛',
          createTime: '2023-3-7 12:01:00'
  ...
  computed: {
    // 将getters中的四个属性映射到计算属性中
    ...mapGetters(['avatar', 'name', 'company', 'departmentName'])
  },
  // 通过监听homeData，等到homeData中有值之后就会自动设置social和povident的setOption
  watch: {
    homeData() {
  ...
  mounted() {
    // 初始化echarts
    // 这里的数据在data中没有声明，不是响应式数据！！！但是可以使用，因为这两个数据不需要响应式
